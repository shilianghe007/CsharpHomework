...
namespace program1
{
    ...
    public class Person
    {
        ...
        public Person (long num, long phone,string goodName,string customerName,double prices)
        {
            this.phone = phone;
            this.num = num;
    ...
    public class OrderService
    {
        ...
        public void Export()
        {
            ...
            {
                addPeople(new Person(num, Phones[i],goodName[i], customerName[i], prices[i]));
                i++;
            }
        ...
        public void deletePhone(int num)
        {
        ...
        //修改
        public bool changeNum(long oldNum, long newNum)
        {
            bool N = true;
        ...
        //查询目标的下标
        public int searchByNum(long Num)
        {
            int flag = 0;
            for(int i=0;i<Nums.Count;i++)
            {
        ...
        public int searchByPhone(long phone)
        {
            int flag = 0;
