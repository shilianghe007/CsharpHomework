        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (num == 0)
            {
                ...
                if(flag0 != -1)
                {
                    ...
                    + form1.os.peoples[flag0].customerName + "  价格是" + form1.os.peoples[flag0].prices + "元" + "  联系方式是：" + form1.os.peoples[flag0].phone;
                }
            ...
            else if(num == 1)
            {
                ...
                if (flag1 != -1)
                {
                    ...
                    + form1.os.peoples[flag1].customerName + "  价格是" + form1.os.peoples[flag1].prices + "元" + "  联系方式是：" + form1.os.peoples[flag1].phone;
                }
                else { textBox2.Text = "sorry~ I don't find your order~"; }
            }
            else if(num == 2)
            {
                ...
                if (flag2 != -1)
                {
                    ...
                    + form1.os.peoples[flag2].customerName + "  价格是" + form1.os.peoples[flag2].prices + "元" + "  联系方式是：" + form1.os.peoples[flag2].phone;
                }
                else { textBox2.Text = "sorry~ I don't find your order~"; }
            }
            else
